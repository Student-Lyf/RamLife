...
/// 
/// Each reminder has a [Reminder.time] property, which is a [ReminderTime], describing when 
/// said reminder should be displayed. Since reminders could be shown on a specific
/// class or period, the classes [PeriodReminderTime] and [SubjectReminderTime] are used. 
...
class PeriodReminderTime extends ReminderTime {
	@override
	final ReminderTimeType type = ReminderTimeType.period;
...
class SubjectReminderTime extends ReminderTime {
	@override 
	final ReminderTimeType type = ReminderTimeType.subject;
